const int ENA[] = {5, 7, 4, 6};
const int IN1[] = {49, 34, 46, 31};
const int IN2[] = {48, 35, 47, 30};
const int encoderPinA[] = {2, 19, 18, 3};
...
const float Kp[] = {1, 1, 1, 1};
const float Ki[] = {0.015, 0.015, 0.015, 0.015};
const float Kd[] = {0.0025, 0.0025, 0.0025, 0.0025};
const float targetRPM = 30;
...
void compute_pid_motor(int index, int target , int dir) {
  ...
  unsigned long deltaTime = currentTime - lastUpdateTime[index]; // Line 37
